...
output_file = "/home/osm/test_1/LLC_output/total_" + args.ksm_type + "_" + args.workload_type + "_" + args.workload_size + ".csv"
...
with open(output_file, 'w') as outfile:
    ...
    writer.writerow(["Time", "LLC-total-access"])
    ...
    for time in times:
        ...
        llc_miss_rate = float(llc_loads_count + llc_stores_count + llc_load_misses_count + llc_store_misses_count)
